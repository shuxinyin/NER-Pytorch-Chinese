...
from config.config import set_train_args, seed_everything, MODEL_CLASS, PROCESSOR_CLASS
...
if __name__ == '__main__':
    ...
    if args.do_train:
        ...
        logger.add(join(args.output_path, 'train-{}-{}.log'.format(args.loss_type, cur_time)))
        logger.info(args)
